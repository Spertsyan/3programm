...
namespace homework
{
    class Program
    {
        ...
        static void Open()
        {
            ...
            Console.WriteLine("1. Вывод делителей числа");
            Console.WriteLine("2. Таблицы умножения");
            Console.WriteLine("3. Угадайте число");
        ...
        static void Input(string input)
        {
            ...
            {
                int min = 0, max = 15;
                Console.WriteLine($"игра угадайте число - Угадайте число от {min} до {max}");
                Console.WriteLine("Чтобы выйти напишите - exit");

                Random rnd = new Random(); //Создание объекта для генерации чисел
                Randomer(rnd.Next(min, max)); //Получить случайное число (в диапазоне от 0 до 15)
            }
        ...
        static void Randomer(int value)
        {
            ...
            if (input == "exit") Open();
            else if (Convert.ToInt32(input) < value) Console.WriteLine("еще больше");
            else if (Convert.ToInt32(input) > value) Console.WriteLine("еще меньше");
